...
public class RareRelicVoider extends AbstractRelicVoider {
    ...
    public RareRelicVoider(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
        super(itemGroup, item, recipeType, recipe, Rarity.RARE);
    }
